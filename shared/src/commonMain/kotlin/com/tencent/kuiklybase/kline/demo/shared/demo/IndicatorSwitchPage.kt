...
class IndicatorSwitchPage : KLineBaseDemoPage() {
    ...
    init {
        val pricePane = KLinePane("price", KLinePaneKind.PRICE, 0, 3.0, 120.0, yAxes = listOf(KLineYAxis("py", 0.0, 100.0)))
        val subPane = KLinePane(subPaneId, KLinePaneKind.INDICATOR, 1, 1.2, 60.0, yAxes = listOf(KLineYAxis("sy", 0.0, 100.0)))
